...
Hey there, this message comes from a [GitHub action](https://github.com/shimizukawa/vite-bundlesize-compare-action) that helps you and reviewers to understand how these changes affect the size of this project's bundle.
